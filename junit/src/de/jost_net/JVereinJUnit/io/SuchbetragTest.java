...
public class SuchbetragTest
{
  ...
  public void test04() throws Exception
  {
    Suchbetrag sb = new Suchbetrag(">1,23");
    Assert.assertEquals(BigDecimal.valueOf(1.23), sb.getBetrag());
    Assert.assertEquals(Suchstrategie.GROESSER, sb.getSuchstrategie());
  }
  ...
  public void test05() throws Exception
  {
    Suchbetrag sb = new Suchbetrag(">=1,23");
    Assert.assertEquals(BigDecimal.valueOf(1.23), sb.getBetrag());
    Assert.assertEquals(Suchstrategie.GROESSERGLEICH, sb.getSuchstrategie());
  }
  ...
  public void test09() throws Exception
  {
    ...
    {
      Assert.assertEquals("Wert ung�ltig", e.getMessage());
    }
  }
