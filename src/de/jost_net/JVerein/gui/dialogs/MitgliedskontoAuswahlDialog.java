...
public class MitgliedskontoAuswahlDialog extends AbstractDialog<Object>
{
  ...
  protected void paint(Composite parent) throws Exception
  {
    ...
    TabGroup tabNurIst = new TabGroup(folder, "Ist-Buchung einer Soll-Buchung zuordenen", false, 1);
    ...
    //
    TabGroup tabSollIst = new TabGroup(folder, "Soll-Buchung ezeugen und Ist-Buchung zuordnen", true, 1);
