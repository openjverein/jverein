...
public class EinstellungControl extends AbstractControl
{
  ...
  public CheckboxInput getVerwendeBelegnummer() throws RemoteException
  {
    ...
    verwendebelegnummer = new CheckboxInput(
        Einstellungen.getEinstellung().getVerwendeBelegnummer());
    verwendebelegnummer.setName(
        "manuelle Belegnummer anstatt Buchungsnummer aus Datenbank verwenden");
    return verwendebelegnummer;
  }
  ...
  public CheckboxInput getBelegnummerProKonto() throws RemoteException
  {
    ...
    belegnummer_pro_konto = new CheckboxInput(
        Einstellungen.getEinstellung().getBelegnummerProKonto());
    belegnummer_pro_konto
        .setName("Jedes Konto erhält eine eigene Belegnummer.");
    return belegnummer_pro_konto;
  }
  ...
  public CheckboxInput getBelegnummerProJahr() throws RemoteException
  {
    ...
    belegnummer_pro_jahr = new CheckboxInput(
        Einstellungen.getEinstellung().getBelegnummerProJahr());
    belegnummer_pro_jahr
        .setName("Jedes Geschäftsjahr erhält eine eigene Belegnummer.");
    return belegnummer_pro_jahr;
  }
