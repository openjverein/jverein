...
public class DbBereinigenView extends AbstractView
{
  ...
  public void bind() throws Exception
  {
    ...
    LabelGroup groupspendenbescheinigungen = new LabelGroup(getParent(),
    ...
    LabelGroup grouplastschriften = new LabelGroup(getParent(),
        "Lastschriften");
    ...
    LabelGroup groupabrechnungslauf = new LabelGroup(getParent(),
        "Abrechnungsläufe");
    ...
    LabelGroup groupjahresabschluss = new LabelGroup(getParent(),
        "Jahresabschlüsse");
