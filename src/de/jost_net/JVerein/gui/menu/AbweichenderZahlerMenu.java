 ...
 */
public class AbweichenderZahlerMenu extends ContextMenu
{

  public AbweichenderZahlerMenu()
  {
    addItem(new CheckedSingleContextMenuItem("Mitglied anzeigen",
        new MitgliedDetailAction(), "user-friends.png"));
    addItem(new AngehoerigerItem("Abweichenden Zahler entfernen",
        new AbweichenderZahlerEntfernenAction(), "user-trash-full.png"));
  }
