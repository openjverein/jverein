...
public class MitgliedskontoImpl extends AbstractDBObject implements Mitgliedskonto {
		...
		try {
			if (this.getRechnung() != null) {
				throw new ApplicationException(
						"Sollbuchung kann nicht gelöscht werden weil sie zu einer " + "Rechnung gehört");
			}
			...
			throw new ApplicationException("Sollbuchung kann nicht gelöscht werden. Siehe system log");
		}
	}
	...
	public Double getIstSumme() throws RemoteException {
		...
		String sql = "select sum(betrag) from buchung where mitgliedskonto = " + this.getID();
