...
public class Update0418 extends AbstractDDLUpdate
{
  ...
  public void run() throws ApplicationException {
    ...
    try {
      ...
      // neue Felder hinzuf�gen und dabei VersionsNr erst einmal nicht ver�ndern!
      ...
      while (res.next()) {
        ...
        switch (choice) {
          ...
          case "Verwendungszweck":
            // Falls ein String als Grundlage f�r den Import verwendet werden soll, werden die
            // Zahlen bis zur ersten "Nichtzahl" f�r die Belegnummer verwendet!
      ...
      // Falls irgendein Fehler aufgetreten ist, die neuen Spalten wieder l�schen!
