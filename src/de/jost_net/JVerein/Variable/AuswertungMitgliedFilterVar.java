...
public enum AuswertungMitgliedFilterVar
{
  ...
  STICHTAG_U("filter_geburtsdatum_von_u"),
  ...
  DATUM_EINTRITT_VON_U("filter_eintrittsdatum_von_u"),
  DATUM_EINTRITT_BIS_F("filter_eintrittsdatum_bis_f"),
  DATUM_EINTRITT_BIS_U("filter_eintrittsdatum_bis_u"),
  DATUM_AUSTRITT_VON_F("filter_austrittsdatum_von_f"),
  DATUM_AUSTRITT_VON_U("filter_austrittsdatum_von_u"),
  DATUM_AUSTRITT_BIS_F("filter_austrittsdatum_bis_f"),
  DATUM_AUSTRITT_BIS_U("filter_austrittsdatum_bis_u"),
  DATUM_STERBE_VON_F("filter_sterbedatum_von_f"),
  DATUM_STERBE_VON_U("filter_sterbedatum_von_u"),
  DATUM_STERBE_BIS_F("filter_sterbedatum_bis_f"),
  DATUM_STERBE_BIS_U("filter_sterbedatum_bis_u"),
