...
public class SpendenbescheinigungAusgabe extends AbstractAusgabe
{
      ...
      DocumentException
  {
    ...
    for (DBObject o : list)
    {
      ...
      if (spendeformular == null && art == Ausgabeart.PDF)
      {
        throw new ApplicationException(
            "PDF mit mehren Standard Spendenbescheinigungen wird nicht unterstützt!");
      }
    }
      ...
      throws IOException, DocumentException
  {
    ...
    try
    {
      ...
      {
        rpt.addHeaderColumn("", Element.ALIGN_CENTER, 100,
      ...
      if (isSammelbestaetigung)
      {
        ...
        rpt.add("für den Zeitraum vom " + (String) map
            .get(SpendenbescheinigungVar.SPENDENZEITRAUM.getName()), 8);
  ...
  {
    // Nur Formulare müssen geschlossen werden, keine
    // Standart-Spendenbescheinigungen
