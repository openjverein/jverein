...
public class Buchungsuebernahme {
  ...
  private void uebernahme() {
    try {
      Logger.info("Buchungs�bernahme zu JVerein gestartet");

      // Protokollliste initialisieren
      buchungen = new ArrayList<>();
      // �ber alle Hibiscus-Konten (aus JVerein-Sicht) iterieren
      ...
      Logger.info("Buchungs�bernahme zu JVerein abgeschlossen");
    } catch (Exception e) {
      Logger.error("Buchungs�bernahme zu JVerein fehlerhaft", e);
    }
    try {
