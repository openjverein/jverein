...
public enum VorlageTyp
{
  ...
  LEHRGAENGE_DATEINAME("lehrgaenge-dateiname", "Lehrgänge Dateiname",
      "Lehrgänge-$aktuellesdatum-$aktuellezeit",
      Vorlageart.DATEINAME.getKey()),
  ...
  PROJEKTE_DATEINAME("projekte-dateiname", "Projekte Dateiname",
      "Projekte-$aktuellesdatum-$aktuellezeit",
      Vorlageart.DATEINAME.getKey()),
  STEUERN_DATEINAME("steuern-dateiname", "Steuern Dateiname",
      "Steuern-$aktuellesdatum-$aktuellezeit",
      Vorlageart.DATEINAME.getKey()),
  ...
  ZUSATZBETRAEGE_SUBTITEL("zusatzbetraege-subtitel",
      "Zusatzbeträge Subtitel", "", Vorlageart.TITEL.getKey()),
  ...
  KURSTEILNEHMER_SUBTITEL("kursteilnehmer-subtitel",
      "Kursteilnehmer Subtitel", "", Vorlageart.TITEL.getKey()),
  ...
  WIEDERVORLAGEN_SUBTITEL("wiedervorlagen-subtitel",
      "Wiedervorlagen Subtitel", "", Vorlageart.TITEL.getKey()),
