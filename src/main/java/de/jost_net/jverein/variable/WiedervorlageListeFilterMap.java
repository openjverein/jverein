...
public class WiedervorlageListeFilterMap extends AbstractMap
{
      ...
      Map<String, Object> inma) throws RemoteException
  {
    ...
    for (WiedervorlageListeFilterVar var : WiedervorlageListeFilterVar
        .values())
    {
      Object value = null;
      switch (var)
