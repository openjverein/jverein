...
public enum VorlageTyp
{
  ...
  ABRECHNUNGSLAUF_BUCHUNGEN_DATEINAME("abrechnungslauf-buchungen-dateiname",
      ...
      Vorlageart.DATEINAME.getKey()),
  ABRECHNUNGSLAUF_ALLEBUCHUNGEN_DATEINAME(
      "abrechnungslauf-allebuchungen-dateiname",
      "Abrechnungslauf Zugeordnete Buchungen Dateiname",
      "Abrechnungslauf-Zugeordnete-Buchungen-$parameter_lauf-$aktuellesdatum-$aktuellezeit",
      Vorlageart.DATEINAME.getKey()),
  ...
  ABRECHNUNGSLAUF_BUCHUNGEN_SUBTITEL("abrechnungslauf-buchungen-subtitel",
      ...
      "Nr. $parameter_lauf zum $udateformat.format(\"dd.MM.yyyy\",$udateformat.parse(\"yyyyMMdd\",$parameter_datum_f))",
      Vorlageart.TITEL.getKey()),
  ABRECHNUNGSLAUF_ALLEBUCHUNGEN_TITEL("abrechnungslauf-allebuchungen-titel",
      "Abrechnungslauf Zugeordnete Buchungen Titel",
      "Abrechnungslauf Zugeordnete Buchungen", Vorlageart.TITEL.getKey()),
  ABRECHNUNGSLAUF_ALLEBUCHUNGEN_SUBTITEL(
      "abrechnungslauf-allebuchungen-subtitel",
      "Abrechnungslauf Zugeordnete Buchungen Subtitel",
      "Nr. $parameter_lauf zum $udateformat.format(\"dd.MM.yyyy\",$udateformat.parse(\"yyyyMMdd\",$parameter_datum_f))",
      Vorlageart.TITEL.getKey()),
