...
public class LehrgangListeView extends AbstractView
{
  ...
  public void bind() throws Exception
  {
    ...
    left.addInput(control.getFilterInput(Filter.LEHRGANGSART));

    SimpleContainer middle = new SimpleContainer(cl.getComposite());
    middle.addInput(control.getFilterInput(Filter.BEZEICHNUNG));
    middle.addInput(control.getFilterInput(Filter.VERANSTALTER));
    ...
    buttons.addButton(new HelpButton(DokumentationUtil.LEHRGANG));
    buttons.addButton(
        new NewButton(new NewAction(LehrgangDetailView.class, Lehrgang.class)));
